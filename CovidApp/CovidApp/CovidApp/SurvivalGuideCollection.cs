    ...
    public static class SurvivalGuideCollection
    {
        ...
        public static void PopulateData()
        {
            Guides = new ObservableCollection<Guide>
            {
                ...
                new Guide(){Info="Try to stay home!!", JsonFilePath="stay_safe_home.json", Details="Staying at home reduces the spread of coronavirus and reduces the risk of getting infected as well as spread to other people."}
