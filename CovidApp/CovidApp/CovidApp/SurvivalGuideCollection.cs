    ...
    public static class SurvivalGuideCollection
    {
        ...
        public static void PopulateData()
        {
            Guides = new ObservableCollection<Guide>
            {
                ...
                new Guide(){Info = "Avoid touching eyes, nose and mouth!!", Details="Hands touch many surfaces and can pick up viruses. Once contaminated, hands can transfer the virus to your eyes, nose or mouth."},
                ...
                new Guide(){Info="Try to stay home!!", Details="Staying at home reduces the spread of coronavirus and reduces the risk of getting infected as well as spread to other people"}
